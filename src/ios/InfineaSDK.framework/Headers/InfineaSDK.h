...
// HID
/**
 Read raw data from HID card. Before reading an HID, dont forget to start the RF module in order to read HID card. And dont forget to close RF after a successful read, or not use anymore. Keeping RF open will drain power dramatically.
...
/**
 ...
 @return NSDictionary The dictionary that contains card info.
 */
